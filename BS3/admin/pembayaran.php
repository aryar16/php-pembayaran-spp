...
?>
    ...
    <center><a href="form_tambah_pembayaran.php" class="btn btn-primary" style="background: #007bff; color: white;">+ &nbsp; Tambah Pembayaran</a> <a href="cetak_pembayaran.php" class="btn btn-danger" style="background: #d9534f; color: white;">+ &nbsp; Cetak Pembayaran</a> <center> 
    <br/>
