...
?>
    ...
    <center><a href="form_tambah_kelas.php" class="btn btn-primary" style="background: #007bff; color: white;">+ &nbsp; Tambah Kelas</a><center>
    <br/>
      ...
      ?>
       <tr>
          ...
          <td>
              ...
              <a href="proses_hapus_kelas.php?id_kelas=<?php echo $row['id_kelas']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
          </td>
      </tr>
