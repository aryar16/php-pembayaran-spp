...
include 'koneksi.php';
  ...
  if (isset($_GET['id_petugas'])) {
    ...
    $query = "SELECT * FROM petugass WHERE id_petugas='$id_petugas'";
...
<html>
  ...
  <title>SMP HASBI HISMANUDIN</title>
    ...
    ?>
      ...
      <section class="base">
        ...
        <div>
         ...
         <input type="text" name="nama_petugas" required="" value="<?php echo $data['nama_petugas']; ?>"/>
        </div>
        <div>
          <label>Level</label>
         <input type="text" name="level" required="" value="<?php echo $data['level']; ?>"/>
        </div>
